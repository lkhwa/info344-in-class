...
func main() {
	...
	//results := make(chan *JobResult) //unbuffered - wait until other goroutine takes it
	results := make(chan *JobResult, 1000) //buffer channel - add more until specified capacity
